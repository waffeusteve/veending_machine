...
/**
 * Created by Paul Antoine on 4/13/2021
 */
public class EncryptorProjurise {

    public static String encrypt(String privateKey, String initVector, String value) {
        try {
    ...
    public static String decrypt(String privateKey, String initVector, String encrypted) {
        try {
            IvParameterSpec iv = new IvParameterSpec(initVector.getBytes("UTF-8"));
            SecretKeySpec skeySpec = new SecretKeySpec(privateKey.getBytes("UTF-8"), "AES");
